...
def parse_args():
    ...
    parser.add_argument("--dev_portal_address", default="132.69.207.29",
...
class DevicePortalBrowser(object):
    ...
    def connect(self, address, username, password):
        ...
        for package in packages["InstalledPackages"]:
            print("found a package named:", package["Name"])
            if "new_StreamRecorder" in package["Name"]:
        ...
        #self.package_full_name = "sr-after-resetjdhbaskj"
        ...
        req = urllib.request.Request(urlrequest, headers={'User-Agent': 'Mozilla/5.0'})

...
def find_odd_image(images):
    image_scores = []
    for index in range(len(images)):
        comparisons = 0
        image_score = 0
        if index != 0:
            score = image_diff(images[index], images[index - 1])
            image_score += score
            comparisons += 1
            print("comparing image ", index, "with image: ", [index-1])
        ...
        image_score = image_score / comparisons
        print("total_score for image:  ", index, "is: ", image_score)

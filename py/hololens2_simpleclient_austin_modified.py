...
if __name__ == '__main__':
    ...
    while True:
        if np.any(video_receiver.latest_frame):
            ...
            pv_timestamp = pv_hdr.Timestamp


            if prev_pv_timestamp == pv_timestamp:
                print(" ===================== look into this pv problem!!!!!!! =====================")
                pv_timestamp = str(pv_timestamp) + "_" + str(counter)
                counter += 1
            prev_pv_timestamp = pv_timestamp


            cv2.imwrite("C:/Users/jonathan_pc/Desktop/projectx/py/22_3_22___13_10/pv/" + str(pv_timestamp) + "rgb.png",
        ...
        if ahat_receiver and np.any(ahat_receiver.latest_frame):
            ...
            depth_timestamp = depth_hdr.Timestamp


            if prev_depth_timestamp == depth_timestamp:
                print(" ===================== look into this depth problem!!!!!!! =====================")
                depth_timestamp = str(depth_timestamp) + "_" + str(counter)
                counter += 1
            ...
            output_path = "C:/Users/jonathan_pc/Desktop/projectx/py/22_3_22___13_10/pv/" + depth_timestamp + ".ply"
            save_one += 1
